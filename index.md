...
description: "Pay-per-call music API over x402: generate full songs from $0.50, split stems, verify on-chain rights, rework old recordings. USDC on Base, no API key."
permalink: /
---
